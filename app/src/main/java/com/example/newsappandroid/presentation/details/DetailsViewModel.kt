...
import com.example.newsappandroid.domain.usecases.news.DeleteArticle
import com.example.newsappandroid.domain.usecases.news.GetSavedArticle
import com.example.newsappandroid.domain.usecases.news.UpsertArticle
import com.example.newsappandroid.utils.UIComponent
...
class DetailsViewModel @Inject constructor(
    ...
    private suspend fun deleteArticle(article: Article) {
        ...
        sideEffect = UIComponent.Toast("Article deleted successfully")
    }
